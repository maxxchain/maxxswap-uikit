...
var Logo = function (_a) {
    ...
    return (React__default["default"].createElement(Flex, null,
        ...
        isAbsoluteUrl ? (React__default["default"].createElement(StyledLink, { as: "a", removeNav: removeNav, href: href, "aria-label": "Wiz home page" }, innerLogo)) : (React__default["default"].createElement(StyledLink, { removeNav: removeNav, to: href, "aria-label": "Wiz home page" }, innerLogo))));
};
var templateObject_1$c;
...
var AccountModal = function (_a) {
    ...
    return (React__default["default"].createElement(Modal, { title: "Your wallet", onDismiss: onDismiss },
        ...
        React__default["default"].createElement(Flex, { mb: "32px" },
            React__default["default"].createElement(LinkExternal, { small: true, href: "https://explorer.memescan.io/address/" + account, mr: "16px" }, "View on POM Explorer"),
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#FAF9FA", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#eeeaf4", inputBorder: "#cccccc", tertiary: "#EFF4F5", text: "#452A7A", textDisabled: "#BDC2C4", textSubtle: "#7d45c7", borderColor: "#E9EAEB", card: "#FFFFFF", gradients: {
        bubblegum: "linear-gradient(139.73deg, #E6FDFF 0%, #F3EFFF 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#b8c0ff", background: "#1f2b46", backgroundDisabled: "#3c3742", contrast: "#FFFFFF", invertedContrast: "#0a0e17", input: "#483f3b", inputBorder: "#cccccc", primaryDark: "#d95b00", tertiary: "#2d2f37", text: "#FFFFFF", textDisabled: "#666171", textSubtle: "#fff", borderColor: "#524B63", card: "#001021", gradients: {
